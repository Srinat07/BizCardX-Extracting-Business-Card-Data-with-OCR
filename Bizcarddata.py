...
icon = Image.open("C:/Users/srifileproject/OneDrive/Desktop/PROJECT 3/icon.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By SRINATH .K",
                   page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *SRINATH.K*!"""})
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"],
                       ...
                       styles={"nav-link": {"font-size": "39px", "text-align": "centre", "margin": "-4px", "--hover-color": "#ed646d"},
                               "icon": {"font-size": "35px"},
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:/Users/Srifileproject/OneDrive/Desktop/PROJECT 3/bizcard.png"),width=500)
